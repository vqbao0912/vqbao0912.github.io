...
const vietnamese = {
  ...
  "Computer vision assistance for people with visual impairments": "Thiết bị hỗ trợ người khiếm thị ứng dụng thị giác máy tính",
  "UAV systems for human detection": "Hệ thống máy bay không người lái phát hiện con người",
  "Deep learning for medical image analysis in cancer diagnosis": "Ứng dụng học sâu phân tích ảnh y khoa trong chẩn đoán ung thư",
  "IoT applications for health monitoring": "Ứng dụng IoT trong giám sát sức khỏe",
